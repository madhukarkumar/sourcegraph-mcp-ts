 ...
 */
async function convertWithOpenAI(naturalQuery: string): Promise<string> {
  if (!OPENAI_API_KEY) {
 ...
 */
async function convertWithAnthropic(naturalQuery: string): Promise<string> {
 ...
 */
function createOpenAIPrompt(naturalQuery: string): string {
  return `
 ...
 */
function createAnthropicPrompt(naturalQuery: string): string {
  return `
Convert the following natural language query into a Sourcegraph search query syntax.
 ...
 */
function fallbackQueryConversion(naturalQuery: string): string {
